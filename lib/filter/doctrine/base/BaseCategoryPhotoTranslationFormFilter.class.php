...
/**
 * CategoryPhotoTranslation filter form base class.
 *
 * @package    sf_sandbox
 * @subpackage filter
 ...
 */
abstract class BaseCategoryPhotoTranslationFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('category_photo_translation_filters[%s]');
