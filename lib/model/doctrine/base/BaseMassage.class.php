 ...
 * @method Massage setName()             Sets the current record's "name" value
 * @method Massage setText()             Sets the current record's "text" value
 * @method Massage setMetaTitle()        Sets the current record's "meta_title" value
 * @method Massage setMetaKeywords()     Sets the current record's "meta_keywords" value
 * @method Massage setMetaDescription()  Sets the current record's "meta_description" value
 * 
 * @package    sf_sandbox
 * @subpackage model
 ...
 */
abstract class BaseMassage extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('massage');
