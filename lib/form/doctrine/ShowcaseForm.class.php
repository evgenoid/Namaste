...
class ShowcaseForm extends BaseShowcaseForm
{
  public function configure()
  {
      ...
      $this->setWidget('filename', new sfWidgetFormInputFileEditable(array(
          ...
          'file_src'  =>  '/uploads/showcase/'.$this->getObject()->getFilename(),
          'with_delete' => true,
      ...
      $this->validatorSchema['filename_showcase'] = new sfValidatorPass();
      $this->setWidget('delete_showcase', new DelShowcase(array(
